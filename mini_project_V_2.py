...
Tops = Frame(root, bg='cyan2', bd=20, pady=5, relief=RIDGE)
Tops.pack(side=TOP)

lblTitle = Label(Tops, font=('arial', 60, 'bold'), text="     Restaurant Management System    ", bd=21, bg='yellow',
...
Cost_F=Frame(MenuFrame, bg='orchid1', bd=4)
Cost_F.pack(side=BOTTOM)
Drinks_F=Frame(MenuFrame, bg='Dark Orchid3', bd=10)
Drinks_F.pack(side=TOP)

Drinks_F=Frame(MenuFrame, bg='DarkOrange1', bd=10, relief=RIDGE)
Drinks_F.pack(side=LEFT)
Cake_F=Frame(MenuFrame, bg='DarkOrange1', bd=10, relief=RIDGE)
...
lblCostOfDrinks = Label(Cost_F, font=('arial', 14, 'bold'), text="   Cost of Beverages\t  ", bd=21, bg='orchid1', fg='black')
...
lblCostOfMeals = Label(Cost_F, font=('arial', 14, 'bold'), text="  Cost of Meals   ", bd=21, bg='orchid1', fg='black')
...
lblServicecharge = Label(Cost_F, font=('arial', 14, 'bold'), text="  Service Charge   ", bd=21, bg='orchid1', fg='black')
...
lblPaidTax = Label(Cost_F, font=('arial', 14, 'bold'), text="\tPaid Tax\t", bd=7, bg='orchid1', fg='black')
lblPaidTax.grid(row=0, column=2, sticky=W)
txtPaidTax = Entry(Cost_F, bg="white", bd = 7, insertwidth=2, font=('arial', 14, 'bold'), justify=RIGHT, textvariable=PaidTax)
txtPaidTax.grid(row=0, column=3)

lblSubTotal = Label(Cost_F, font=('arial', 14, 'bold'), text="\tSub Total", bd=7, bg='orchid1', fg='black')
...
lblTotalCost = Label(Cost_F, font=('arial', 14, 'bold'), text="\tTotal Cost", bd=7, bg='orchid1', fg='black')
